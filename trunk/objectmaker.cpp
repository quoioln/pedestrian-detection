...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	if((hFile=_findfirst("F:\\测试素材\\MIT_standard_person\\pedestrians128x64\\*.ppm",&bmp_file))==-1L)
		printf("no *.bmp files in directory 'rawdata'\n");
	else
	{

		//	init highgui
		cvAddSearchPath("F:\\测试素材\\MIT_standard_person\\pedestrians128x64\\");
		...
		do
		{
			...
			numOfRec=1;
			strPostfix="";
			strPrefix="F:\\测试素材\\MIT_standard_person\\pedestrians128x64\\";
